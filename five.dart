...
class _LoginFormState extends State<LoginForm> {
  ...
  // Add a Bluetooth device variable
  BluetoothDevice? _bluetoothDevice;

  // Method to send commands to the Arduino
  void _sendCommandToArduino(String command) {
    if (_bluetoothDevice != null) {
      // Send the command to the Arduino via Bluetooth
      // You'll need to implement the actual Bluetooth communication logic here
      // This can involve writing to a specific characteristic or sending data over the Bluetooth channel
    }
  }
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              _sendCommandToArduino('PUMP_OFF');
            },
